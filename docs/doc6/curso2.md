## CURSO 2: EL PODER DEL VOTO

**Nivel:** Básico  
**Duración:** 12 minutos  

### Descripción Corta
Tu voto cambia el Perú. Conoce cómo funciona el sistema de votación, qué impacto tiene tu voto y por qué importa cada elección. Entiende el poder que tienes en tus manos.

### Objetivos de Aprendizaje
- Comprender el funcionamiento del sistema electoral peruano
- Conocer los diferentes tipos de elecciones en Perú
- Entender cómo se cuentan los votos y se asignan escaños
- Reconocer la importancia de la participación electoral

### Tags
`voto` `sufragio` `elecciones` `democracia` `participación` `electoral`

---

### LECCIÓN 1: TU VOTO TIENE MÁS PODER DEL QUE CREES
...
### LECCIÓN 2: ¿CÓMO SE CUENTAN LOS VOTOS?
...
### LECCIÓN 3: VOTACIÓN PRESIDENCIAL - SISTEMA DE DOS VUELTAS
...
### LECCIÓN 4: VOTO PREFERENCIAL - TÚ ELIGES AL CANDIDATO
...
### LECCIÓN 5: TU VOTO EN NÚMEROS - IMPACTO REAL
...
**1. ¿Qué se necesita para ganar en primera vuelta presidencial?**
- a) 40% de votos válidos
- b) Más del 50% de votos válidos ✓
- c) 30% de votos totales
- d) Ser el más votado, sin importar el porcentaje

**2. ¿Cuál es la valla electoral para partidos individuales en el Congreso?**
- a) 3% de votos válidos
- b) 4% de votos válidos
- c) 5% de votos válidos ✓
- d) 10% de votos válidos

**3. ¿Qué es el voto preferencial?**
- a) Votar por tu candidato favorito dentro del partido ✓
- b) Votar en blanco
- c) Votar por varios partidos
- d) Votar solo por el presidente

**4. ¿Cuánto fue el ausentismo en Lima en las elecciones 2021?**
- a) 500,000 personas
- b) 1 millón de personas
- c) Más de 2 millones de personas ✓
- d) 3 millones de personas

**5. ¿Los votos en blanco y nulos se cuentan para elegir autoridades?**
- a) Sí, cuentan igual que los válidos
- b) No, solo se contabilizan pero no definen ganadores ✓
- c) Solo los nulos se cuentan
- d) Solo los en blanco se cuentan

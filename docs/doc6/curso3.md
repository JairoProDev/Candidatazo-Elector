## CURSO 3: ¿QUÉ ES LA CONSTITUCIÓN?

**Nivel:** Básico  
**Duración:** 10 minutos  

### Descripción Corta
La carta magna explicada en términos simples. Derechos, deberes, organización del Estado y poderes. Entiende la Constitución sin abogados.

### Objetivos de Aprendizaje
- Comprender qué es una Constitución y para qué sirve
- Conocer la estructura de la Constitución Política de Perú (1993)
- Identificar los derechos fundamentales que te protegen
- Entender la organización del Estado peruano

### Tags
`constitución` `derechos` `estado` `democracia` `leyes`

---

### LECCIÓN 1: LA CONSTITUCIÓN EN TÉRMINOS SIMPLES
...
### LECCIÓN 2: TUS DERECHOS FUNDAMENTALES
...
### LECCIÓN 3: DERECHOS SOCIALES Y ECONÓMICOS (CAPÍTULO II)
...
### LECCIÓN 4: ORGANIZACIÓN DEL ESTADO (TÍTULO IV)
...
### LECCIÓN 5: ¿CÓMO SE REFORMA LA CONSTITUCIÓN?
...
- a) Un conjunto de leyes ordinarias
- b) La ley suprema del país ✓
- c) Una guía moral sin valor legal
- d) El reglamento del Congreso

**2. ¿Cuál de estos NO es un derecho fundamental en la Constitución?**
- a) Derecho a la vida
- b) Libertad de expresión
- c) Derecho a tener auto propio ✓
- d) Derecho a la educación

**3. ¿Cuántos poderes del Estado establece la Constitución peruana?**
- a) 2 (Ejecutivo y Legislativo)
- b) 3 (Ejecutivo, Legislativo, Judicial) ✓
- c) 4 (Ejecutivo, Legislativo, Judicial, Electoral)
- d) 5 (Ejecutivo, Legislativo, Judicial, Electoral, Contralor)

**4. ¿Qué se necesita para reformar la Constitución en el Congreso?**
- a) Mayoría simple (50% + 1)
- b) Aprobación en una sola votación
- c) Aprobación dos veces en diferentes legislaturas ✓
- d) Solo el Presidente puede reformarla

**5. ¿En qué año fue promulgada la Constitución vigente?**
- a) 1979
- b) 1993 ✓
- c) 2000
- d) 1933

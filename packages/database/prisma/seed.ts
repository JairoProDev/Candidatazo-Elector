...
async function main() {
  ...
  const candidates = [
    {
      ...
      age: 50,
      bio: "Keiko Sofia Fujimori Higuchi es una politica peruana, lideresa del partido Fuerza Popular. Hija del expresidente Alberto Fujimori, ha sido candidata presidencial en 2011, 2016 y 2021. Congresista en el periodo 2006-2011. Estudio Administración en Boston University y MBA de Columbia Business School.",
      positions: { economic: 72, social: 28, environment: 35, security: 85, institutional: 30 },
      truthScore: 45,
      planSummary: "Plan centrado en seguridad ciudadana, reactivación economica mediante inversion privada, programas sociales focalizados y lucha frontal contra el narcotrafico.",
    ...
    },
    {
      ...
      truthScore: 30,
      planSummary: "Nacionalización de recursos naturales, pena de muerte, servicio militar obligatorio.",
      featured: false,
    },
    {
      name: "Cesar Acuña",
      ...
      truthScore: 38,
      planSummary: "Obras publicas, educación tecnica, empleo juvenil y programas sociales.",
      featured: false,
    },
    {
      name: "Daniel Urresti",
      ...
      truthScore: 42,
      planSummary: "Militarización de la seguridad, penas mas duras, modernización policial.",
      featured: false,
    },
    {
      ...
      age: 41,
      bio: "Excongresista y politologa. Lideresa de la izquierda democratica. Propone nueva Constitución y derechos sociales.",
      positions: { economic: 25, social: 82, environment: 85, security: 30, institutional: 88 },
      truthScore: 55,
      planSummary: "Nueva Constitucion, renegociación de contratos mineros, matrimonio igualitario y transición energetica.",
    ...
    },
    {
      ...
      age: 84,
      bio: "Economista reconocido internacionalmente. Autor de 'El Misterio del Capital'. Propone formalización masiva.",
      positions: { economic: 88, social: 55, environment: 45, security: 45, institutional: 65 },
      truthScore: 52,
      planSummary: "Formalización masiva, derechos de propiedad digitales, simplificación tributaria.",
    ...
    },
    {
      ...
      truthScore: 50,
      planSummary: "Modernización del Estado, gobierno digital, reforma educativa, lucha anticorrupcion.",
      featured: false,
    },
    {
      name: "George Forsyth",
  ...
  const promises = [
    ...
    { candidateSlug: "keiko-fujimori", title: "Crear 1 millon de empleos formales", description: "Incentivos tributarios y simplificación de tramites.", category: "ECONOMY" as const },
    ...
    { candidateSlug: "veronika-mendoza", title: "Renegociar contratos mineros", description: "Mayor participación del Estado en ganancias mineras.", category: "ECONOMY" as const },
    { candidateSlug: "hernando-de-soto", title: "Formalizar 12 millones de peruanos", description: "Programa masivo de formalización con tecnologia digital.", category: "ECONOMY" as const },
    ...
    { candidateSlug: "julio-guzman", title: "Reforma educativa integral", description: "Incrementar presupuesto de educación al 6% del PBI.", category: "EDUCATION" as const },
  ];
  ...
  // ==================== ADN QUESTIONS ====================
  console.log("Creating ADN questions...");

  const questions = [
    // ECONOMIC
    { text: "El Estado debería controlar los precios de productos basicos?", dimension: "ECONOMIC" as const, order: 1, options: [{ value: -100, label: "Si, fijar precios" }, { value: -50, label: "Solo esenciales" }, { value: 0, label: "No estoy seguro" }, { value: 50, label: "Incentivos al mercado" }, { value: 100, label: "Mercado se regula solo" }], context: "El precio del balon de gas fluctua entre S/40-60." },
    ...
    { text: "Aumentar impuestos a los mas ricos?", dimension: "ECONOMIC" as const, order: 3, options: [{ value: -100, label: "Mucho mas altos" }, { value: -50, label: "Moderadamente" }, { value: 0, label: "Mantener" }, { value: 50, label: "Reducir para inversion" }, { value: 100, label: "Reducir drasticamente" }], context: "Perú recauda 16.8% del PBI, bajo en la region." },
    ...
    { text: "Libre comercio y TLCs?", dimension: "ECONOMIC" as const, order: 6, options: [{ value: -100, label: "Renegociar" }, { value: -50, label: "Mas protecciones" }, { value: 0, label: "Sin opinion" }, { value: 50, label: "Son positivos" }, { value: 100, label: "Mas apertura" }], context: "Perú tiene TLCs con EE.UU., China y la UE." },
    // SOCIAL
    { text: "Matrimonio entre personas del mismo sexo?", dimension: "SOCIAL" as const, order: 1, options: [{ value: 100, label: "Matrimonio pleno" }, { value: 50, label: "Union civil" }, { value: 0, label: "Sin opinion" }, { value: -50, label: "No cambiar la ley" }, { value: -100, label: "No, hombre y mujer" }], context: "Perú no tiene union civil ni matrimonio igualitario." },
    ...
    { text: "Despenalizar aborto en caso de violacion?", dimension: "SOCIAL" as const, order: 3, options: [{ value: 100, label: "Si, mas causales" }, { value: 50, label: "Violación e inviabilidad" }, { value: 0, label: "Sin posicion" }, { value: -50, label: "Solo terapeutico" }, { value: -100, label: "En ningun caso" }], context: "400,000 abortos clandestinos estimados por año." },
    { text: "Regular consumo de marihuana?", dimension: "SOCIAL" as const, order: 4, options: [{ value: 100, label: "Uso recreativo" }, { value: 50, label: "Solo medicinal" }, { value: 0, label: "Sin opinion" }, { value: -50, label: "Mantener" }, { value: -100, label: "Endurecer penas" }], context: "Perú permite uso medicinal limitado." },
    { text: "Rol de la religion en el gobierno?", dimension: "SOCIAL" as const, order: 5, options: [{ value: 100, label: "Separación total" }, { value: 50, label: "Respetar sin imponer" }, { value: 0, label: "Balance" }, { value: -50, label: "Valores religiosos importan" }, { value: -100, label: "Fe guia politicas" }], context: "Perú tiene concordato con el Vaticano." },
    { text: "Inmigración venezolana?", dimension: "SOCIAL" as const, order: 6, options: [{ value: 100, label: "Integrar con derechos" }, { value: 50, label: "Regularizar" }, { value: 0, label: "Depende" }, { value: -50, label: "Restringir" }, { value: -100, label: "Deportar" }], context: "1.5 millones de venezolanos en Perú." },
    // ENVIRONMENT
    { text: "Protección ambiental sobre mineria?", dimension: "ENVIRONMENT" as const, order: 1, options: [{ value: 100, label: "Ambiente primero" }, { value: 50, label: "Regulación estricta" }, { value: 0, label: "Equilibrio" }, { value: -50, label: "Mineria es clave" }, { value: -100, label: "Priorizar mineria" }], context: "Mineria = 10% del PBI pero genera conflictos." },
    { text: "Eliminar deforestación en la Amazonia?", dimension: "ENVIRONMENT" as const, order: 2, options: [{ value: 100, label: "Cero inmediata" }, { value: 50, label: "Reducción gradual" }, { value: 0, label: "Sin posicion" }, { value: -50, label: "Uso sostenible" }, { value: -100, label: "Desarrollo necesita tierras" }], context: "150,000+ hectareas perdidas por año." },
    { text: "Inversion en energia renovable?", dimension: "ENVIRONMENT" as const, order: 3, options: [{ value: 100, label: "Transición acelerada" }, { value: 50, label: "Invertir gradualmente" }, { value: 0, label: "Depende del costo" }, { value: -50, label: "Priorizar economia" }, { value: -100, label: "No es prioridad" }], context: "Perú tiene enorme potencial solar y eolico." },
    ...
    { text: "Prohibir plasticos de un solo uso?", dimension: "ENVIRONMENT" as const, order: 5, options: [{ value: 100, label: "Prohibición total" }, { value: 50, label: "Gradual" }, { value: 0, label: "Sin opinion" }, { value: -50, label: "Solo incentivos" }, { value: -100, label: "No prohibir" }], context: "6.8 millones toneladas de residuos/año." },
    ...
    // SECURITY
    { text: "Endurecer penas para delitos violentos?", dimension: "SECURITY" as const, order: 1, options: [{ value: 100, label: "Mucho mas duras" }, { value: 50, label: "Delitos graves" }, { value: 0, label: "Depende" }, { value: -50, label: "Prevencion" }, { value: -100, label: "Rehabilitacion" }], context: "85% de percepción de inseguridad." },
    { text: "Fuerzas Armadas en las calles?", dimension: "SECURITY" as const, order: 2, options: [{ value: 100, label: "Si, situación amerita" }, { value: 50, label: "Zonas criticas" }, { value: 0, label: "No seguro" }, { value: -50, label: "Fortalecer policia" }, { value: -100, label: "Riesgo autoritario" }], context: "Varios candidatos proponen militarizacion." },
    { text: "Pena de muerte para violadores de menores?", dimension: "SECURITY" as const, order: 3, options: [{ value: 100, label: "Si" }, { value: 50, label: "Cadena perpetua" }, { value: 0, label: "No seguro" }, { value: -50, label: "Penas duras" }, { value: -100, label: "Derechos inviolables" }], context: "Perú firmo convención que prohibe reinstaurar pena de muerte." },
    ...
    { text: "Negociar o combatir el narcotrafico?", dimension: "SECURITY" as const, order: 6, options: [{ value: 100, label: "Combate militar" }, { value: 50, label: "Combate + desarrollo" }, { value: 0, label: "Estrategia integral" }, { value: -50, label: "Desarrollo sobre represion" }, { value: -100, label: "Legalizar" }], context: "Perú es 2do productor de coca mundial." },
    // INSTITUTIONAL
    { text: "Asamblea Constituyente para nueva Constitucion?", dimension: "INSTITUTIONAL" as const, order: 1, options: [{ value: 100, label: "Nueva Constitucion" }, { value: 50, label: "Reformas profundas" }, { value: 0, label: "Sin posicion" }, { value: -50, label: "Reformas puntuales" }, { value: -100, label: "Mantener actual" }], context: "Constitución de 1993 de Fujimori." },
    ...
    { text: "Voto obligatorio o voluntario?", dimension: "INSTITUTIONAL" as const, order: 5, options: [{ value: 100, label: "Obligatorio con sancion" }, { value: 50, label: "Obligatorio sin multa" }, { value: 0, label: "Sin posicion" }, { value: -50, label: "Transición a voluntario" }, { value: -100, label: "Voluntario ya" }], context: "Multa de S/88 por no votar." },
  ...
  const factChecks = [
    ...
    { candidateSlug: "antauro-humala", claim: "El 80% de la riqueza del Perú se va al extranjero", verdict: "FALSE" as const, explanation: "Las utilidades repatriadas son ~5-6% del PBI.", sources: [{ title: "BCRP Balanza de Pagos", url: "https://www.bcrp.gob.pe" }], confidence: 0.97, featured: true },
    { candidateSlug: "keiko-fujimori", claim: "La pobreza se redujo a 11% con el modelo del 93", verdict: "MISLEADING" as const, explanation: "Nunca llego a 11%. La reducción tuvo multiples causas.", sources: [{ title: "INEI", url: "https://www.inei.gob.pe" }], confidence: 0.88, featured: true },
    { candidateSlug: "cesar-acuna", claim: "La UCV es la universidad con mas alumnos del Perú", verdict: "TRUE" as const, explanation: "Con mas de 100,000 alumnos es una de las mas grandes.", sources: [{ title: "SUNEDU", url: "https://www.sunedu.gob.pe" }], confidence: 0.90, featured: false },
    { candidateSlug: "george-forsyth", claim: "Reduje el crimen en La Victoria en un 40%", verdict: "HALF_TRUE" as const, explanation: "Hubo mejoras pero la reducción fue menor al 40%.", sources: [{ title: "PNP", url: "https://www.policia.gob.pe" }], confidence: 0.72, featured: false },
  ...
  const tribes = [
    ...
    { name: "Izquierda Progresista", slug: "izquierda-progresista", description: "Justicia social, derechos humanos y protección ambiental como prioridades.", color: "#EF4444", criteria: { economic: [0, 40], social: [65, 100], environment: [60, 100] } },
    ...
    { name: "Conservador Tradicional", slug: "conservador-tradicional", description: "Valores familiares, tradición y estabilidad.", color: "#7C3AED", criteria: { social: [0, 40] } },
    ...
    { name: "Ambientalista", slug: "ambientalista", description: "La protección del planeta como prioridad numero uno.", color: "#059669", criteria: { environment: [75, 100] } },
    ...
    { name: "Centro Derecha", slug: "centro-derecha", description: "Moderados con inclinación hacia el libre mercado.", color: "#6366F1", criteria: { economic: [55, 70] } },
    { name: "Centro Izquierda", slug: "centro-izquierda", description: "Moderados con inclinación hacia la justicia social.", color: "#F97316", criteria: { economic: [30, 50] } },
  ];
  ...
  const achievements = [
    { key: "dna_complete", name: "ADN Descubierto", description: "Completaste tu ADN Politico", icon: "dna", rarity: "COMMON" as const, xp: 100 },

...
const CANDIDATES_DETAIL: Record<string, {
  ...
  "keiko-fujimori": {
    ...
    age: 50,
    bio: "Keiko Sofia Fujimori Higuchi es una politica peruana, lideresa del partido Fuerza Popular. Hija del expresidente Alberto Fujimori, ha sido candidata presidencial en 2011, 2016 y 2021. Congresista en el periodo 2006-2011. Estudio Administración de Empresas en Boston University y tiene un MBA de Columbia Business School.",
    positions: { economic: 72, social: 28, environment: 35, security: 85, institutional: 30 },
    truthScore: 45,
    planSummary: "Plan centrado en seguridad ciudadana con participación de Fuerzas Armadas, reactivación economica mediante inversion privada, programas sociales focalizados y lucha frontal contra el narcotrafico. Propone mantener el modelo economico constitucional con ajustes.",
    promises: [
      ...
      { title: "Crear 1 millon de empleos formales", description: "A traves de incentivos tributarios a empresas, simplificación de tramites y promoción de la inversion privada.", category: "ECONOMY", status: "PENDING" },
      ...
      { title: "Reducir la pobreza al 15%", description: "Mediante programas sociales focalizados y reactivación economica.", category: "SOCIAL", status: "PENDING" },
    ...
    factChecks: [
      ...
      { claim: "La pobreza se redujo a 11% con el modelo economico de la Constitución del 93", verdict: "MISLEADING", explanation: "La pobreza se redujo de 58% a 20.2% (2019), pero no a 11%. Ademas, otros factores como el boom de commodities contribuyeron significativamente." },
    ],
  ...
  "veronika-mendoza": {
    ...
    age: 41,
    bio: "Veronika Fanny Mendoza Frisch es una politica y politologa peruana. Fue congresista de 2011 a 2016 por Cusco. Lideresa de Nuevo Perú y la izquierda democratica. Estudio en la Sorbona de Paris y en la PUCP. Candidata presidencial en 2016 y 2021.",
    positions: { economic: 25, social: 82, environment: 85, security: 30, institutional: 88 },
    truthScore: 55,
    planSummary: "Plan centrado en nueva Constitución con Asamblea Constituyente, renegociación de contratos mineros, segundo aguinaldo, impuesto a las grandes fortunas, derechos de pueblos indigenas, matrimonio igualitario y transición energetica.",
    promises: [
      ...
      { title: "Matrimonio igualitario", description: "Aprobar el matrimonio civil para parejas del mismo sexo en Perú.", category: "SOCIAL", status: "PENDING" },
      { title: "Renegociar contratos mineros", description: "Renegociar contratos con las grandes mineras para obtener mayor participación del Estado en las ganancias.", category: "ECONOMY", status: "PENDING" },
    ...
    factChecks: [
      { claim: "El 1% mas rico del Perú tiene tanto como el 90% mas pobre", verdict: "MOSTLY_TRUE", explanation: "Segun Oxfam, el 1% mas rico concentra el 30% de la riqueza nacional, pero la comparación exacta con el 90% varia segun la metodologia." },
  ...
  "hernando-de-soto": {
    ...
    party: "Avanza Pais",
    age: 84,
    bio: "Hernando de Soto Polar es un economista peruano reconocido internacionalmente. Autor de 'El Otro Sendero' y 'El Misterio del Capital'. Presidente del Instituto Libertad y Democracia (ILD). Asesor de gobiernos de mas de 30 paises en formalización y derechos de propiedad.",
    positions: { economic: 88, social: 55, environment: 45, security: 45, institutional: 65 },
    truthScore: 52,
    planSummary: "Plan centrado en la formalización masiva de la economia, derechos de propiedad para todos, tecnologia blockchain para registros publicos, simplificación tributaria radical y apertura a mercados internacionales.",
    promises: [
      { title: "Formalizar a 12 millones de peruanos", description: "Programa masivo de formalización con tecnologia digital, reduciendo tramites de meses a dias.", category: "ECONOMY", status: "PENDING" },
      ...
      { title: "Simplificación tributaria radical", description: "Reducir el numero de impuestos y crear un regimen simplificado para micro y pequeñas empresas.", category: "ECONOMY", status: "PENDING" },
    ...
    factChecks: [
      { claim: "El 70% de la economia peruana es informal", verdict: "TRUE", explanation: "Segun el INEI, aproximadamente el 72.7% del empleo en Perú es informal (2023), lo que respalda esta afirmacion." },
...
const BASIC_CANDIDATES: Record<string, { name: string; party: string; age: number; bio: string; positions: Record<string, number>; truthScore: number; planSummary: string; promises: { title: string; description: string; category: string; status: string }[]; factChecks: { claim: string; verdict: VerdictType; explanation: string }[] }> = {
  "antauro-humala": {
    ...
    age: 61,
    bio: "Exmilitar y lider etnocacerista. Propone nacionalización radical y refundación del Estado peruano.",
    positions: { economic: 15, social: 20, environment: 40, security: 95, institutional: 90 },
    truthScore: 30,
    planSummary: "Nacionalización de recursos naturales, pena de muerte, servicio militar obligatorio, expulsion de empresas transnacionales.",
    promises: [
    ...
    factChecks: [
      { claim: "El 80% de la riqueza del Perú se va al extranjero", verdict: "FALSE", explanation: "Las utilidades repatriadas por empresas extranjeras representan aprox. 5-6% del PBI, no 80%." },
    ],
  },
  "cesar-acuna": {
    name: "Cesar Acuña",
    ...
    promises: [
      { title: "Becas para 1 millon de jovenes", description: "Programa de becas para educación tecnica y superior.", category: "EDUCATION", status: "PENDING" },
    ],
    factChecks: [
      { claim: "La UCV es la universidad con mas alumnos del Perú", verdict: "TRUE", explanation: "La Universidad Cesar Vallejo tiene mas de 100,000 alumnos, siendo una de las mas grandes del pais." },
    ],
  },
  "daniel-urresti": {
    name: "Daniel Urresti",
    ...
    factChecks: [
      { claim: "Como ministro reduje el crimen en Lima en un 30%", verdict: "HALF_TRUE", explanation: "Hubo reducción en algunos indicadores durante su gestion pero no en la magnitud señalada." },
    ],
  },
  "julio-guzman": {
    name: "Julio Guzman",
    ...
    promises: [
      ...
      { title: "Reforma educativa integral", description: "Incrementar el presupuesto de educación al 6% del PBI.", category: "EDUCATION", status: "PENDING" },
    ],
    factChecks: [
  ...
  "george-forsyth": {
    ...
    promises: [
      { title: "Camaras inteligentes en todo el Perú", description: "Instalar un sistema de videovigilancia con IA en las 50 ciudades mas grandes.", category: "SECURITY", status: "PENDING" },
    ],
    factChecks: [
      { claim: "Como alcalde reduje el crimen en La Victoria en un 40%", verdict: "HALF_TRUE", explanation: "Hubo mejoras en orden pero las cifras oficiales de reducción del crimen son menores." },
    ],
  },
};
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="card">
              <h2 className="font-bold text-gray-800 mb-4">
                Verificación de Datos ({candidate.factChecks.length})
              </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="card bg-gradient-to-br from-primary-50 to-secondary-50 border border-primary-100 text-center">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Completa el ADN Test para ver tu porcentaje de compatibilidad.
              </p>

...
const FACT_CHECKS: {
  ...
  featured: boolean;
}[] = [
    {
      ...
      source: "Debate TV",
      verdict: "TRUE",
      explanation: "Segun el INEI (Instituto Nacional de Estadistica e Informatica), el empleo informal en Perú alcanza el 72.7% de la fuerza laboral (2023). Esta cifra es una de las mas altas de America Latina y se ha mantenido relativamente estable en los ultimos años.",
    ...
    },
    {
      ...
      verdict: "HALF_TRUE",
      explanation: "El crecimiento promedio durante el gobierno de Alberto Fujimori (1990-2000) fue de aproximadamente 4.5% anual. Si bien hubo años excepcionales como 1994 (12.8%) y 1997 (6.9%), tambien hubo años de recesion como 1990 (-5.1%) y 1998 (-0.7%). La cifra de 7% es una exageración del promedio real.",
    ...
    },
    {
      ...
      verdict: "MOSTLY_TRUE",
      explanation: "Segun el informe de Oxfam 'Desigualdad en America Latina', el 1% mas rico de Perú concentra aproximadamente el 30% de la riqueza nacional. Si bien la comparación exacta con el 90% varia segun metodologia (Credit Suisse estima diferente), la tendencia de extrema concentración es real y documentada.",
    ...
    },
    {
      ...
      source: "Entrevista",
      verdict: "HALF_TRUE",
      explanation: "La carga tributaria efectiva sobre la mineria en Perú es comparable a la de Chile pero significativamente menor que en Bolivia. Perú cobra impuesto a la renta (29.5%), regalias (1-12%) y impuesto especial a la mineria. Chile tiene un royalty minero reciente que elevo su carga. Bolivia tiene un regimen estatal mas pesado.",
      candidateName: "Veronika Mendoza",
      candidateSlug: "veronika-mendoza",
      candidateParty: "Juntos por el Perú",
      confidence: 0.68,
      sources: [
        ...
        { title: "CEPAL - Tributación Minera en America Latina", url: "https://www.cepal.org" },
      ],
    ...
    },
    {
      ...
      source: "Mitin",
      verdict: "TRUE",
      explanation: "La Universidad Cesar Vallejo, fundada por Cesar Acuña, tiene mas de 100,000 alumnos matriculados, siendo efectivamente una de las universidades mas grandes del Perú y de America Latina por numero de estudiantes.",
    ...
    },
    {
      ...
      source: "Debate TV",
      verdict: "MISLEADING",
      explanation: "La pobreza en Perú se redujo de 58% (2004) a 20.2% (2019), pero nunca llego a 11%. Ademas, la reducción se debio a multiples factores: boom de commodities, politicas sociales, crecimiento global favorable, y no exclusivamente al modelo constitucional. Post-pandemia la pobreza subio a 27.5%.",
      candidateName: "Keiko Fujimori",
      candidateSlug: "keiko-fujimori",
      candidateParty: "Fuerza Popular",
      confidence: 0.88,
